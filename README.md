# Lab Data Mount System (NEMO CE Plugin & Storage Daemon)
...
* **[signals.py](NEMO/plugins/lab_mount/signals.py)**: Listens to Django auth signals and tool check-in/check-out events. Extracts user credentials and group permissions, then delegates calls.
* **[client.py](NEMO/plugins/lab_mount/client.py)**: Handles connection logic and signs all requests with SHA-256 HMAC utilizing the shared secret.
...
└── nemo-ce/                # Local Django Application (This Repository)
